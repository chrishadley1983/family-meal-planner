...
// =============================================================================
// UK/US SYNONYM MAPPINGS (bidirectional normalization to a canonical form)
// =============================================================================

const INGREDIENT_SYNONYMS: Record<string, string> = {
  // Vegetables - UK/US variations
  'aubergine': 'eggplant',
  'courgette': 'zucchini',
  'courgettes': 'zucchini',
  'rocket': 'arugula',
  ...
  'pepper': 'bell pepper', // context-dependent, but often means bell pepper
  ...
  // Herbs - UK/US variations
  'coriander seed': 'coriander seeds',
  'coriander seeds': 'coriander seeds', // keep as-is (spice, not herb)
  ...
  'extra mature cheddar': 'extra sharp cheddar',
  ...
  // Stock & Broth (these are effectively the same for shopping)
  ...
  'beef stock cube': 'beef bouillon cube',
