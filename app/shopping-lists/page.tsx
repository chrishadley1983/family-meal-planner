          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            {filteredLists.map((list) => (
              <div
                ...
                className="bg-gray-800 rounded-lg shadow-sm overflow-hidden cursor-pointer hover:shadow-lg hover:bg-gray-750 transition-all border border-gray-700"
              >
                {/* Card Header */}
                ...
                {/* Card Actions */}
                <div className="px-4 py-3 bg-gray-750 border-t border-gray-700 flex justify-end gap-2">
                  {list.status === 'Draft' && (
                    <button
                      onClick={(e) => handleArchiveList(e, list.id)}
                      className="text-sm text-gray-400 hover:text-gray-200 px-2 py-1"
                    >
                      Archive
                    </button>
                  )}
